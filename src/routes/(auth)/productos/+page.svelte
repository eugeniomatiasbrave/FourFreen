...
<Titulo {titulo}/>
	...
	<!--------------------------Seccion tabla --> 	
	  <div class="bg-white mx-auto p-1 pt-1 rounded-lg border border-gray-300 shadow-md w-full xl:w-1/2"><!----------------Div contenedor: tabla + add + Filtro--------->
					...
					<TableBodyRow class=" hover:bg-hover-gray-light">
						...
						{#if visibleColumns.editar}
						 <TableBodyCell class="py-2">
						  <a  href={`/productos/${prod.producto_id}?action=editar`} data-sveltekit-preload-code="hover"
						...
						{#if visibleColumns.eliminar}
					     <TableBodyCell class="py-2">		
					  	  <a href={`/productos/${prod.producto_id}?action=eliminar`} data-sveltekit-preload-code="hover"
