<script>
	...
	const detalle = data.detalle.datos;
	console.log(detalle);
</script>
...
<main class="bg-gray-50 dark:bg-gray-900 sm:p-3 mx-1 w-full">
	<div class="my-4">
		<h3
			class="text-3xl font-bold text-center py-2 bg-gradient-to-r
	  from-secundary-400 from-30% via-primary-500 via-50% to-primary-500 to-50% text-transparent bg-clip-text"
		>
			Detalle de pedido
		</h3>
	</div>
